        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="{{ asset('front-end/img/carousel-1.jpg') }}" class="img-fluid" alt="First slide">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('front-end/img/carousel-2.jpg') }}" class="img-fluid" alt="Second slide">
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            <h6 class="text-secondary h4 animated fadeInUp">Best IT Solutions</h6>
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="{{ asset('front-end/img/about-1.jpg') }}" class="img-fluid w-75 rounded" alt=""
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    <h5 class="text-primary">Tentang BEM FTI</h5>
                    <h1 class="mb-4">Badan Eksekutif Mahasiswa Fakultas Teknologi Informasi</h1>
    ...
    <div class="container-fluid services py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary">Konsentrasi Ilmu</h5>
                <h1>Bidang Pengembangan dan Keilmuan Teknologi Informasi</h1>
            </div>
    ...
    <div class="container-fluid blog py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <h1>Informasi & Berita Terbaru</h1>
            </div>
            <div class="row g-5 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".7s">
                    <div class="blog-item position-relative bg-light rounded">
                        <img src="{{ asset('front-end/img/blog-3.jpg') }}" class="img-fluid w-100 rounded-top"
                            alt="">
